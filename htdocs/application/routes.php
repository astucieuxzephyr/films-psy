...
Route::get('/', function()
{
	...
	// Par défaut : l'URL Base de l'application retourne home/index.php
	// return View::make('home.index');
	
	// Réglage Tanguy
	// l'URL Base de l'application redirige vers le controleur Post
...
{
	// ORIGINAL
	// Si la personne n'est pas authentifiée on retourne à la fonction login
