...
/**
 * action_index principale méthode de user
...
/**
 * action_signup Action user.signup : voir Views/user/signup.blade.php
 * @return [type] [description]
 */
...
/**
 * action_logout Action de Déconnexion
